## Check if downloaded data is available
...
## Format date and subset the data
...
## Create the plot and set canvas for 4 plots
...
# Second plot
plot(data$timestamp, df.power$Sub_metering_1, type="l", xlab="",
